...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/Bootstrap_CV_Homo1_n_all.csv",
                      header = TRUE,
                      sep = ",")
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Performance_2.2.s_ChgMeanB100_3rt_n_noCali16052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
