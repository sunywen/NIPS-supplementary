...
for (m in 1:M){
  ...
  for (i in 1:B){
    ...
    tao = min(which(I_testM != 0)) #First detected CP
    ChgPtMST[m,i] = I_testM[tao]
...
Performance = data.frame(d=CV_table$d,n=CV_table$n,SensitivityAC,SensitivityMST,DelayMST,DelayAC)
#saveRDS(Performance,file="/Users/yangwen/Documents/Research/Programing/Data/Performance_2.2_ChgMeanB1000_3rt_10052019.Rda")
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/DetecDelay_2.3.2_VarB100N100_2V_n_20052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
