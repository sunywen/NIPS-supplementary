...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/OnlinePermuCali with HomoVar_B1000.csv",
                      header = TRUE,
                      sep = ",")
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Performance_2.2_ChgMeanB1000_3rt_modi.csv", sep = ",", col.names = NA,
            qmethod = "double")
