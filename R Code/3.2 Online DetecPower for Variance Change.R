...
Performance = data.frame(d,AccuracyAC,AccuracyMST,SensitivityAC,SensitivityMST,FPR_AC,FPR_MST)
#saveRDS(ChgPtAC,file="/Users/yangwen/Documents/Research/Programing/Data/ChangePointLocationB100N200AC_17052019.Rda")
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/3.2_OnlineChgVarB1000N100_Part6_23052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
