...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/Critical_value_n_Selected.csv",
                      header = TRUE,
                      sep = ",")
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/3.1_OnlineHomoVar_B1000_n.csv", sep = ",", col.names = NA,
            qmethod = "double")
