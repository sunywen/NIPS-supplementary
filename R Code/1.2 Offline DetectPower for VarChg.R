...
for (m in 1:M){
  ...
  for (i in 1:N){
    ...
    mu2 = rep(0, d)
    Sigma2 = diag(1+I_true[i]*1.5,d) #* (I_true[i]*3+1)
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Performance_Var1.p5_10052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
