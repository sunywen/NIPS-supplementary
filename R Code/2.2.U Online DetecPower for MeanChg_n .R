...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/OnlinePermuCali with HomoVar_B1000_n_UTstat.csv",
                      header = TRUE,
                      sep = ",")
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Performance_2.2.U_ChgMeanB100_3rt_n_U16052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
