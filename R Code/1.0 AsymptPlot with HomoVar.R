...
pdf("/Users/yangwen/Desktop/Research/Analysis/Asymptotics of the Tstat of mean - MST, Homogeneous variance.pdf")
...
grid.arrange(
  ...
  top = "Asymptotics of the Tstat of mean - MST, Homogeneous variance",
    #expression(paste("Asymptotics of ", rho[alpha], "of mean - MST, Homogeneous variance ")), 
  bottom = textGrob(
    "1.1",
...
pdf("/Users/yangwen/Desktop/Research/Analysis/Asymptotics of the Tstat of variance - MST, Homogeneous variance.pdf")
...
pdf("/Users/yangwen/Desktop/Research/Analysis/Asymptotics of the Tstat of mean - AC, Homogeneous variance.pdf")
...
pdf("/Users/yangwen/Desktop/Research/Analysis/Asymptotics of the Tstat of variance - AC, Homogeneous variance.pdf")
