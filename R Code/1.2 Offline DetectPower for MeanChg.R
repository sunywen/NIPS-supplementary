...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/Bootstrap_CV_Homo1.csv",
                      header = TRUE,
                      sep = ",")
...
Performance = data.frame(d=CV_table$d,n=CV_table$n,AccuracyAC,AccuracyMST,AccuracyR,SensitivityAC,SensitivityMST,SensitivityR)
saveRDS(Performance,file="/Users/yangwen/Documents/Research/Programing/Data/Performance_MeanSqrt1_100_1d_3_10052019.Rda")
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Performance_MeanSqrt1_100_1d_3_10052019.csv", sep = ",", col.names = NA,
            qmethod = "double")
