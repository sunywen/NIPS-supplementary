...
Power_table = read.table("/Users/yangwen/Desktop/Research/Programing/Data/Performance_MeanSqrt1_100_2.csv",
                         header = TRUE,
                         sep = ",")
...
pdf("/Users/yangwen/Desktop/Research/Analysis/Test Accuracy for change in Mean.pdf")
...
grid.arrange(
  ...
  g5,
  nrow = 3, ncol = 2,
  top = "Test Accuracy- for change in Mean", 
  bottom = textGrob(
    "3.1",
...
pdf("/Users/yangwen/Desktop/Research/Analysis/Test Sensitivity for change in Mean.pdf")
...
grid.arrange(
  ...
  g9,
  nrow = 3, ncol = 2,
  top = "Test Sensitivity - for change in Mean", 
  bottom = textGrob(
    "3.2",
    gp = gpar(fontface = 3, fontsize = 9),
    hjust = 1,
