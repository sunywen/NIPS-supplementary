...
CV_table = read.table("/Users/yangwen/Documents/Research/Programing/Data/Critical_value_n_short.csv",
                      header = TRUE,
                      sep = ",")
...
write.table(Performance, file = "/Users/yangwen/Documents/Research/Programing/Data/Bootstrap_CV_Homo1_n_a025.csv", sep = ",", col.names = NA,
            qmethod = "double")
